...
//$Path='C:/laragon/www/developmenthh/PurePhpProyects/Gastos/csv-gastosrep2.csv';
//$Path="C:/Users/cogutierrez/OneDrive - Industrias Habers, S. A. de C. V/Gastos/csv-gastosrep2.csv";
$Path="C:/Users/José Carlos Pacheco/Industrias Habers, S. A. de C. V/Marco Antonio Gil Lozano - Gastos/csv-gastosrep2.csv";
...
function emailsend($emisor,$n_emisor,$psw_emisor,$destinatario,$name_des,$subject,$message,$pathattachment,$copia,$manager){
          ...
          try {
            ...
            //----------------------------------------------------------------------------------------------------------------------
                    ...
                    $correo_destino="jpacheco@h-h.com.mx";      //Correo de quien recibe
                    $nombre_destino="Jose Carlos pacheco";                //Nombre de quien recibe
            //----------------------------------------------------------------------------------------------------------------------
                    $mail->SMTPDebug  = 2;                     // Habilita información SMTP (opcional para pruebas)
                    // 1 = errores y mensajes
                    // 2 = solo mensajes
...
for ($i=0;$i<count($data_colect);$i++ ){
    $cabezera=$data_colect[0];
    if ($i>0 and( !in_array( $data_colect[$i][2],$tiendas_no  ) and !in_array( $data_colect[$i][8],["CERRADAS","na","JACOBO","ECOMMERCE","Ecommerce"] ) ) ){

    for ($j=0;$j<count($data_colect[0]);$j++ ) {


            if (in_array($data_colect[$i][6], array("Punto de equilibrio","Visual","Comision por Uso de Tarjeta", "Agua", "Articulos de Escritorio", "Combustibles y Lubricantes", "Energia Electrica", "Gastos de Viaje", "Gastos no Deducibles I.S.R.", "Mantenimiento", "Mensajeria", "Telefono"))) {

                if ($j == 6) {

                    $estructura[$i][$j] = trim(mb_convert_encoding($data_colect[$i][$j],'ISO-8859-1', 'UTF-8'));

                }
                else {


                    $estructura[$i][$j] = mb_convert_encoding($data_colect[$i][$j],'ISO-8859-1', 'UTF-8');
            ...
            {
                if($j==6){
                    $estructura[$i][$j] =trim(mb_convert_encoding($data_colect[$i][$j]));

                }
                else{
                    $estructura[$i][$j] = mb_convert_encoding($data_colect[$i][$j]);

                }
            }*/


            $dicc_tiendas[$i] = mb_convert_encoding($data_colect[$i][2],'ISO-8859-1', 'UTF-8');
            $dicc_anio[$i] = $data_colect[$i][1];
            switch (trim($data_colect[$i][6])) {

                case trim($data_colect[$i][6]) <> " " or trim($data_colect[$i][6]) <> ""  :

                    $dicc_detalles[$i] = trim(mb_convert_encoding($data_colect[$i][6],'ISO-8859-1', 'UTF-8'));
                ...
                for ($j=0;$j<count($detalles);$j++) {
                    ...
                    for ($k=0; $k<count($estructura);$k++) {
                                ...
                                case $aact:
                                    ...
                                    if(substr($almacen,0,1) =="F" ){
                                        ...
                                        switch ($detalle_load){
                                            ...
                                            case $detalle_load=='Punto de equilibrio':

                                                $sumatm_mes_acu_pe+=floatval(trim(str_replace(",","",$estructura[$k][4]))) ;
                                        ...
                                        switch ($detalle_load){
                                            ...
                                            case $detalle_load=='Punto de equilibrio':
                                                ...
                                                $sumatr_mes_acu_pe+=floatval(trim(str_replace(",","",$estructura[$k][4])));
                                        ...
                                        switch ($detalle_load){
                                            ...
                                            case $detalle_load=='Punto de equilibrio':
                                                ...
                                                $sumath_mes_acu_pe+=floatval(trim(str_replace(",","",$estructura[$k][4]))) ;
                                        ...
                                        switch ($detalle_load){
                                            ...
                                            case $detalle_load=='Punto de equilibrio':
                                                ...
                                                $sumatb_mes_acu_pe+=floatval(trim(str_replace(",","",$estructura[$k][4]))) ;
                            ...
                            if($estructura[$k][0]==$mes_Act and $estructura[$k][1]==$aact){
                                ...
                                if(substr($almacen,0,1) =="F" ){
                                    ...
                                    switch ($detalle_load){
                                        ...
                                        case $detalle_load=='Punto de equilibrio':
                                            ...
                                            $sumatm_mes_act_pe+=floatval(trim(str_replace(",","",$estructura[$k][4]))) ;
                                    ...
                                    switch ($detalle_load){
                                        ...
                                        case $detalle_load=='Punto de equilibrio':
                                            ...
                                            $sumatr_mes_act_pe+=floatval(trim(str_replace(",","",$estructura[$k][4]))) ;
                                ...
                                switch ($detalle_load){
                                    ...
                                    case $detalle_load=='Punto de equilibrio':
                                        ...
                                        $sumath_mes_act_pe+=floatval(trim(str_replace(",","",$estructura[$k][4]))) ;
                                ...
                                switch ($detalle_load){
                                    ...
                                    case $detalle_load=='Punto de equilibrio':
                                        ...
                                        $sumatb_mes_act_pe+=floatval(trim(str_replace(",","",$estructura[$k][4]))) ;
                        ...
                        $almacen=$estructura[$k][2];
                            ...
                            if($detalles[$j]!='Ventas Netas' and $detalles[$j]!='Punto de equilibrio'   ) {
                                ...
                                if(substr($almacen,0,1) =="F" and !in_array( $almacen,$tiendas_no) ){
                                    ...
                                    switch ($detalles[$j]){
                                        ...
                                        case $detalles[$j]=='Ventas Netas':
                                            ...
                                            break;
                                        case $detalles[$j]=='Punto de equilibrio':


                                            $table_show[$i][$j+1][]=$sumatm_mes_act_pe;
                                            $table_show[$i][$j+1][]=$sumatm_mes_acu_pe;
                    ...
                    ELSE    if(substr($almacen,0,1) =="R" and !in_array( $almacen,$tiendas_no) ){
                        ...
                        switch ($detalles[$j]){
                            ...
                            case $detalles[$j]=='Punto de equilibrio':
                                ...
                                $table_show[$i][$j+1][]=$sumatr_mes_act_pe;
                                $table_show[$i][$j+1][]=$sumatr_mes_acu_pe;
                        ...
                        switch ($detalles[$j]){
                            ...
                            case $detalles[$j]=='Punto de equilibrio':
                                ...
                                $table_show[$i][$j+1][]=$sumath_mes_act_pe;
                                $table_show[$i][$j+1][]=$sumath_mes_acu_pe;
                        ...
                        switch ($detalles[$j]){
                            ...
                            case $detalles[$j]=='Punto de equilibrio':
                                ...
                                $table_show[$i][$j+1][]=$sumatb_mes_act_pe;
                                $table_show[$i][$j+1][]=$sumatb_mes_acu_pe;
...
$cuenta_tableshow=count($table_show[0])-4;
  for ($i=0;$i<count($table_show);$i++) {
      ...
      if( !in_array( $table_show[$i][0],$tiendas_no) and !in_array( $table_show[$i][1],["CERRADAS","na","JACOBO","ECOMMERCE","Ecommerce"] ) ){
...
<tr><th colspan='11' class='encabezados-almacen'>" . $table_show[$i][0] ." ". $table_show[$i][15] . "</th></tr>
...
<tr>
    ...
    <td >";
    /*print_r('i:'.$i.' j:'.$j);*//*Valores del array*/
          if ($table_show[$i][1][3]  !== 0 and $table_show[$i][$j][3]  <> 0 and $table_show[$i][1][3] <> 0/* and $table_show[$i][$j][1] != 0*/ ) {
          ...
          $table .=  "%</td>
 <td >";
          if ($table_show[$i][$j][7]  !== 0 and $table_show[$i][$j][7]  <> 0 and $table_show[$i][1][7] <> 0 and( !is_nan( $table_show[$i][$j][7] )  or !is_infinite( $table_show[$i][$j][7] ) or !is_null( $table_show[$i][$j][7]) )   ) {

              $table .= number_format((($table_show[$i][$j][7] / $table_show[$i][1][7]) ) * 100, 2, '.', ',');
          }
          elseif ($table_show[$i][$j][7] === 0 and( is_nan( $table_show[$i][$j][7] )  or is_infinite( $table_show[$i][$j][7]) or is_null( $table_show[$i][$j][7] ) )  ) {
    ...
    <td >";
          if ($table_show[$i][1][6] !== 0 and $table_show[$i][$j][6] <> 0 and $table_show[$i][1][6] <> 0/*and $table_show[$i][$j][4] != 0]*/) {
          ...
          $table .= "%</td>".
              "<td >";
           if (  $table_show[$i][$j][8] !== 0 and $table_show[$i][$j][8] <> 0 and $table_show[$i][1][8] <> 0 and( !is_nan( $table_show[$i][$j][8] )  or !is_infinite( $table_show[$i][$j][8] ) or !is_null( $table_show[$i][$j][8] ))    ) {

              $table .= number_format((($table_show[$i][$j][8] / $table_show[$i][1][8]) ) * 100, 2, '.', ',');
          }
          elseif ($table_show[$i][$j][8] === 0 and( is_nan( $table_show[$i][$j][8])  or is_infinite( $table_show[$i][$j][8] ) or is_null( $table_show[$i][$j][8] ) )  ) {
    ...
    <td>";
      ...
      $table .= '</table>';
        ...
        $table_txt[$i][1]=strval( $table );
          $table_txt[$i][2]=$table_show[$i][17];
          $table_txt[$i][3]=$table_show[$i][18];
          $table_txt[$i][4]=$table_show[$i][15];
          $table_txt[$i][5]=$mes_letra;
          $table_txt[$i][6]=$aact;
          $table_txt[$i][7]=$table_show[$i][16];
...
function emitepdf($stilo,$datos,$namet){
      ...
      $mpdf->SetHTMLHeader (' <div style="overflow: hidden; width: 100%; height: 80px"> 
                    <div style="float: left; width:45% ;"> <img src="../img/newlogo.png"  ></div> 
                    <div style="float: right; width:45% ; font-size: 10px; text-align:left  " >  <h1>Grupo Haber Holding</h1>
        <h2>Cedula de Gastos Operativos</h2>
        <h2>Resultados contables, cifras en pesos</h2></div>
                    
                    </div>');

      $mpdf->writeHTML($stilo, \Mpdf\HTMLParserMode::HEADER_CSS);
      $mpdf->writeHTML($datos, \Mpdf\HTMLParserMode::HTML_BODY);
      //$mpdf->output("C:/laragon/www/developmenthh/Gastos/pdfs/". $namet.".pdf");
      //$mpdf->output("C:/Users/José Carlos Pacheco/Industrias Habers, S. A. de C. V/Marco Antonio Gil Lozano - Gastos/pdfs/". $namet.".pdf");
      // Solo convertir la variable $namet si es necesario, manteniendo la ruta base en UTF-8
$nombre_archivo_pdf = mb_convert_encoding($namet, 'ISO-8859-1', 'UTF-8') . ".pdf";
$mpdf->output("C:/Users/José Carlos Pacheco/Industrias Habers, S. A. de C. V/Marco Antonio Gil Lozano - Gastos/pdfs/" . $nombre_archivo_pdf); 
      var_dump(ob_get_clean());

  }
$message_body=mb_convert_encoding( "<br>Buenas tardes</br>"."
<br></br>
...
<br>4.	Para cualquier duda o aclaración en primer instancia se deberá revisar con el área manager responsable de la tienda y si el lo considera adecuado con gusto les respondo sus dudas: Krista Tapia (dtapia@h-h.com.mx)</br>


",'ISO-8859-1', 'UTF-8');

$email_emi="dtapia@h-h.com.mx";
$nombre_emi="Dafne Kristal Tapia Santillan";
$psw_emi="301%#4Pp";


/*
$email_emi="magil@h-h.com.mx";
$nombre_emi="Carlos Alfonso Navarro Avila";
$psw_emi="LoveEli2019".chr(36);
*/
...
$tdas_not=[
  ...
  for ($i=0;$i<count($table_txt);$i++){
      ...
      $email_mes = strftime("%B", strtotime('-1 month'));
    $nombre_archivo = mb_convert_encoding($table_txt[$i][0], 'ISO-8859-1', 'UTF-8') . '-' . 
                      mb_convert_encoding($aact, 'ISO-8859-1', 'UTF-8') . '-' . 
                      mb_convert_encoding($email_mes, 'ISO-8859-1', 'UTF-8');
    // Generar el PDF antes de enviar el correo
    emitepdf($css, $table_txt[$i][1], $nombre_archivo);
   //   IF(   !in_array($table_txt[$i][0],$tdas_not)  ){
     // emitepdf($css,$table_txt[$i][1],$table_txt[$i][0].'-'.$aact."-".$email_mes );
      if($table_txt[$i][3]=="na"){
      ...
      //$path_file='C:/laragon/www/developmenthh/Gastos/pdfs/'.$table_txt[$i][0].'-'.$aact."-".  $email_mes. '.pdf';
         // $path_file='C:/Users/José Carlos Pacheco/Industrias Habers, S. A. de C. V/Marco Antonio Gil Lozano - Gastos/pdfs/'.$table_txt[$i][0].'-'.$aact."-".  $email_mes. '.pdf';
       // Convertir solo las variables si es necesario, pero NO la ruta base
$nombre_archivo = mb_convert_encoding($table_txt[$i][0], 'ISO-8859-1', 'UTF-8') . '-' . 
                  mb_convert_encoding($aact, 'ISO-8859-1', 'UTF-8') . '-' . 
                  mb_convert_encoding($email_mes, 'ISO-8859-1', 'UTF-8') . '.pdf';

$path_file = 'C:/Users/José Carlos Pacheco/Industrias Habers, S. A. de C. V/Marco Antonio Gil Lozano - Gastos/pdfs/' . $nombre_archivo;
     
      /*
      $path_file2='C:/laragon/www/developmenthh/PurePhpProyects/Gastos/Queries/'.$table_txt[$i][0].'-'.$aact."-".  strftime("%B", strtotime('-3 month')). '.pdf';
      $path_file3='C:/laragon/www/developmenthh/PurePhpProyects/Gastos/Queries/'.$table_txt[$i][0].'-'.$aact."-".  strftime("%B", strtotime('-4 month')). '.pdf';
      $path_file4='C:/laragon/www/developmenthh/PurePhpProyects/Gastos/Queries/'.$table_txt[$i][0].'-'.$aact."-".  strftime("%B", strtotime('-5 month')). '.pdf';
      */
    ...
    emailsend(
        ...
        $nombre_emi,
        $psw_emi,
       "jpacheco@h-h.com.mx",/*$correo_tienda,*/
         $table_txt[$i][4],
       "Cedula Gastos ".$table_txt[$i][5]." ".$table_txt[$i][6],
         $message_body,
         $path_file,
       "jpacheco@h-h.com.mx",/*$correo_manager,*/
    mb_convert_encoding($manager,'ISO-8859-1', 'UTF-8')
        );


print_r($correo_manager."-".$correo_tienda."-".$table_txt[$i][0].'-'.$aact."-".  $email_mes. '.pdf'."\n" );
