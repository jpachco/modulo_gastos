...
gastos_rb  as g left join Tienda  as t  on g.cod_almacen = t.Tienda COLLATE Modern_Spanish_CI_AS
...
$rawdata_colect=execonsultasqlsrv($sql_gastos,$conexionrb,$rawdata_colect);
$data_colect=array();
$dicc_tiendas=array();
$dicc_detalles=array();
...
<tr >
  ...
  function emitepdf($stilo,$datos,$namet){
	...
	width: 100%; height: 120px"> 
      ...
      $datos=mb_convert_encoding($datos, 'UTF-8', 'UTF-8');
  ...
  for ($i=0;$i<count($table_txt);$i++){
     ...
     emitepdf($css,$table_txt[$i][1],$table_txt[$i][0]);
      ...
      if($table_txt[$i][3]=="na"){
        ...
        $path_file='C:/xampp/htdocs/Gastos/Queries/RB/'.$table_txt[$i][0].'.pdf';
