...
<tr>
    ...
    <td >";
          ...
          $table .=  "%</td>
 <td >";
          if ($table_show[$i][$j][7]  != 0 and( !is_nan( $table_show[$i][$j][7] )  or !is_infinite( $table_show[$i][$j][7] ) or !is_null( $table_show[$i][$j][7]) )   ) {
    ...
    <td >";
          ...
          $table .= "%</td>".
              "<td >";
           if (  $table_show[$i][$j][8] != 0 and( !is_nan( $table_show[$i][$j][8] )  or !is_infinite( $table_show[$i][$j][8] ) or !is_null( $table_show[$i][$j][8] ))    ) {
